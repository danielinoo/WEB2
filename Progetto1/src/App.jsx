...
function App() {
  ...
  return (
    <>
      ...
      titolo="TROPEA" 
      descrizione = "descrizione foto" 
      img = "https://www.calabriago.com/wp-content/uploads/2020/06/slide-1.jpg" ></Card>
      
      <Card vis= {false}  
      titolo="MIAMI" 
      descrizione = "descrizione foto" 
      img= "https://plus.unsplash.com/premium_photo-1697730215093-baeae8060bfe?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bWlhbWl8ZW58MHx8MHx8fDA%3D"></Card>
      
      <Card  vis ={false}  
      titolo="ZANTE"
      descrizione = "descrizione foto" 
      img = "https://www.grecia.info/wp-content/uploads/sites/71/zante.jpg"></Card>


      <Card  vis ={false}  
      titolo="PUNTA CANA" 
      descrizione = "descrizione foto" 
      img="https://d2lxis1uiqe6st.cloudfront.net/wp-content/uploads/2023/08/puntacana.png"></Card>
      ...
      {/* filtro lista (con filter) */}
      {/* se vis è true allora stampa la card altrimenti no */}
      {listacitta.filter((citta) => citta.vis).map((citta) => 
             <Card key={citta.id}
             titolo = {citta.titolo}
             descrizione = {citta.descrizione}
             vis = {citta.img}
